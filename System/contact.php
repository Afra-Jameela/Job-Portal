					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Salem, <br/> Tamilnadu.</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:jobportal@gmail.com">jobportal@gmail.com</a>
								</li>
								<li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Job Portal</h5>
											<p>It is a job portal, online job management system developed by Afra Jameela for her project.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title"> Job Portal Contact</h5>
								
								<p>Address : Salem, Tamilnadu</p>
								<p>Email : <a href="mailto:jobportal@gmail.com">jobportal@gmail.com</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Job Portal Vision Software</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Afra Jameela</a></li>
								</ul>
