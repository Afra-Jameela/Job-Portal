...
<head>
	...
	<title>Job Portal - Applicants for the job <?php echo "$job_title"; ?></title>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-9">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<h5 class="footer-title">About Jobs</h5>
											<p>It is a job portal, online job management system developed by Afra.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Email : <a href="jobportal@gmail.com">jobportal@gmail.com</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?>Job Portal Software</p>
